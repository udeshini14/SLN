...
class [[controller_name]] extends CI_Controller 
{
    ...
    function index()
    {
		...
		if(count(cbeads_get_loaded_model_names_for_db('[[namespace]]')) == 0)
		{
        ...
        // This will render a menu where each tab corresponds to a different model. The 'application/models/[[namespace]]' folder
